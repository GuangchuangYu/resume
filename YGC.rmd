...
<i class="fa fa-book"></i> CERTIFICATE
---------

2015
:   *Certificate of Teaching and Learning in Higher Education*, Centre for Enhancement of Teaching and Learning, The University of Hong Kong

<i class="fa fa-university"></i> EMPLOYMENT
---------

2017
:   Post-doctoral Fellow, *State Key Laboratory of Infectious Diseases, School of Public Health, The University of Hong Kong:*
...
<i class="fa fa-slideshare"></i> Teaching
-------------------
...
<i class="fa fa-database"></i> Grants
------
2013
...
```{r echo=FALSE}
hotpaper <- function() {
    sprintf("%s", '<font color="red"><i class="fa fa-fire"></i></font>')
}
hcitepaper <- function() {
    sprintf("%s", '<font color="orange"><i class="fa fa-trophy"></i></font>')
}
```


&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font color="red"><i class="fa fa-fire"></i></font> ESI Hot Paper (X1)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font color="orange"><i class="fa fa-trophy"></i></font> ESI Highly Cited Paper (X4)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; *Methods in Ecology and
Evolution* (X1, rank 11 in *Environment Ecology*, IF = 5.708)
...
90. __G Yu__. [Using meshes for MeSH term enrichment and semantic analyses](https://doi.org/10.1093/bioinformatics/bty410).
    __*Bioinformatics*__. 2018, 34(21):3766–3767.
...
`r hotpaper()` `r hcitepaper()` `r badge_citation("HtEfBTGE9r8C", "14021087557216297475", "blue")`
92. __G Yu__, QY He^\*^. [ReactomePA: an R/Bioconductor package for reactome pathway analysis and visualization](http://pubs.rsc.org/en/Content/ArticleLanding/2016/MB/C5MB00663E). __*Molecular BioSystems*__. 2016, 12(2):477-479.
 `r hcitepaper()` `r badge_citation("8d8msizDQcsC", "3311691878690959578", "blue")`
...
`r hcitepaper()` `r badge_citation("9pM33mqn1YgC", "12053363057899219488", "blue")`
94.	__G Yu__^\*^, LG Wang, GR Yan, QY He^\*^. [DOSE: an R/Bioconductor package for Disease Ontology Semantic and Enrichment analysis](http://bioinformatics.oxfordjournals.org/cgi/content/abstract/btu684). __*Bioinformatics*__. 2015, 31(4):608-609.
 `r badge_citation("Ug5p-4gJ2f0C", "10904694463327099987", "blue")`
...
98.	__G Yu__, LG Wang, Y Han, QY He^\*^. [clusterProfiler: an R package for comparing biological themes among gene clusters](http://online.liebertpub.com/doi/abs/10.1089/omi.2011.0118). __*OMICS: A Journal of Integrative Biology*__. 2012, 16(5):284-287.
 `r hcitepaper()` `r badge_citation("MLfJN-KU85MC", "2349076811020942117", "blue")`
...
<i class="fa fa-group"></i> Conference Proceedings
-----------------
...
<i class="fa fa-video-camera"></i> Public Media
-----------------

"Plotting trees + data" lecture by Guangchuang Yu. https://youtu.be/tqspAXM0UQE


<i class="fa fa-home"></i> Professional Affiliations
----------
...
2015
:   **Steering Committee**; International Network for Data Analysis, Institut Pasteur

2005-2009
:   **Visiting Student**; Beijing Institute of Radiation Medicine


<i class="fa fa-user"></i> Professional Services
------------------
...
<i class="fa fa-gears"></i> Software Development
--------------------
...
> **R ranking**: ranked `r gitaward("guangchuangyu", "r")` worldwide by [Git Awards](http://git-awards.com/users/guangchuangyu)

[badger](https://cran.r-project.org/package=badger)
:   `r packageTitle('badger', 'CRAN')`

[dlstats](https://cran.r-project.org/package=dlstats)
:   `r packageTitle('dlstats', 'CRAN')`

[emojifont](https://guangchuangyu.github.io/emojifont)
:   `r packageTitle('emojifont', 'CRAN')`

[ggplotify](http://cran.r-project.org/package=ggplotify)
:   `r packageTitle('ggplotify', 'CRAN')`

[ggimage](https://cran.r-project.org/package=ggimage)
:   `r packageTitle('ggimage', 'CRAN')`

[meme](http://cran.r-project.org/package=meme)
:   `r packageTitle('meme', 'CRAN')`

[rvcheck](https://cran.r-project.org/package=rvcheck)
:   `r packageTitle('rvcheck', 'CRAN')`

[scatterpie](https://cran.r-project.org/package=scatterpie)
:   `r packageTitle('scatterpie', 'CRAN')`

[shadowtext](http://cran.r-project.org/package=shadowtext)
:   `r packageTitle('shadowtext', 'CRAN')`

[ChIPseeker](https://guangchuangyu.github.io/ChIPseeker)
:   `r packageTitle('ChIPseeker', 'BioC')`

[clusterProfiler](https://guangchuangyu.github.io/clusterProfiler)
:   `r packageTitle('clusterProfiler', 'BioC')`

[DOSE](https://guangchuangyu.github.io/DOSE)
:   `r packageTitle('DOSE', 'BioC')`

[ggtree](https://guangchuangyu.github.io/ggtree)
:   `r packageTitle('ggtree', 'BioC')`

[GOSemSim](https://guangchuangyu.github.io/GOSemSim)
:   `r packageTitle('GOSemSim', 'BioC')`

[meshes](https://guangchuangyu.github.io/meshes)
:   `r packageTitle('meshes', 'BioC')`

[ReactomePA](https://guangchuangyu.github.io/ReactomePA)
:   `r packageTitle('ReactomePA', 'BioC')`

[seqcombo](https://www.bioconductor.org/packages/seqcombo)
:   `r packageTitle('seqcombo', 'BioC')`

[tidytree](https://cran.r-project.org/package=tidytree)
:   `r packageTitle('tidytree', 'CRAN')`

[TIPars](https://github.com/id-bioinfo/TIPars)
:   Taxa Insertion by Parsimony

[treeio](https://bioconductor.org/packages/treeio)
:   `r packageTitle('treeio', 'BioC')`

### **Contributions to open source libraries**

[basicTrendline](https://cran.r-project.org/package=basicTrendline)
:   `r packageTitle('basicTrendline', 'CRAN')`

[cowsay](https://cran.r-project.org/package=cowsay)
:   `r packageTitle('cowsay', 'CRAN')`

[kableExtra](https://cran.r-project.org/package=kableExtra)
:   `r packageTitle('kableExtra', 'CRAN')`
...
:   `r packageTitle('MSnbase', 'BioC')`

[pheatmap](https://cran.r-project.org/package=pheatmap)
:   `r packageTitle('pheatmap', 'CRAN')`

[scholar](https://github.com/jkeirstead/scholar)
:   `r packageTitle('scholar', 'CRAN')`
